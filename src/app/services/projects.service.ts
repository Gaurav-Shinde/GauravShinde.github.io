...
export class ProjectsService {
    projects: Project[] = [
        ...
        { id: 2, name: "Fraudulent Job Classification", pictures: ["assets/fraud-jobs_class/c1.PNG", "assets/fraud-jobs_class/c2.PNG", "assets/fraud-jobs_class/c3.PNG"], projectLink: "//www.github.com", summary: "ML models performance comparison on Fraudulent Jobs dataset.", description: "Add later", tags: [Tag.PYTHON] },
